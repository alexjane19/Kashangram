...
public class BaseDrawerActivity extends BaseActivity {
    public static final String URL_UPLOADED_IMAGE = URL_SERVER + "/api/image/";
    ...
    //String profilePhoto = URL_SERVER + URL_UPLOAD_IMAGE;
    ...
    private void setupHeader() {
        ...
        String [] infouser  = getPhotoID(getApplicationContext());
        TextView textView =  (TextView) headerView.findViewById(R.id.tvMenuUserProfileTitle);
        textView.setText(infouser[0]);
        String photo = URL_UPLOADED_IMAGE + infouser[1];
    ...
    private String [] getPhotoID(Context context) {
        ...
        String []values  = {prefs.getString(USER_ID, ""), prefs.getString(PHOTO_ID, "")+ ".jpg"};
